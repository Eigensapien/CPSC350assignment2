    ...
    */
    ...
    for (int i=0; i<height; ++i)
    {
        for (int j=0; j<width; ++j)
        {
            ...
            {
                board[ width*height + i*width + j ] = 'X';
                board[ i*width + j ] = 'X';
            }
            else
            {
                board[ width*height + i*width + j ] = '-';
                board[ i*width + j ] = '-';
            }
        }
    }
...
opening:
    ...
    for (int i=0; i<height; ++i)
    {
        ...
        for (int j=0; j<width; ++j)
        {
            ...
            {
                cout << "Error: improper character when importing board." << endl;
            }
        }
    }
    ifs.close()
...
//------------------------------------------------------------------------------
void LifeBoard::saveBoard(ofstream ofs)
{
    cout << "Output to file not yet implimented" << endl;
}
//------------------------------------------------------------------------------
